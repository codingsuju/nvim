...
let g:python3_host_prog = 'C:\tools\neovim\env\Scripts\python.exe'
...
augroup compileandrun
    ...
    "autocmd filetype java nnoremap <f5> :w <bar> !buildjava % <cr>
    autocmd filetype kt nnoremap <f5> :w <bar> !buildkt % <cr>
augroup END